...
interface IPoqLotteryV3 {
     ...
     */
    function buyTickets(uint256 _lotteryId, uint32[] calldata _ticketNumbers,bool isPoint) external payable;
	...
	function viewCurrentLotteryStartTime() external view returns (uint256);
